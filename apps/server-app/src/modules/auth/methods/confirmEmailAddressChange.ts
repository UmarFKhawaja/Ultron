...
export function confirmEmailAddressChange(container: Container) {
  ...
  return async (req: Request, res: Response): Promise<void> => {
    try {
      ...
      const information: Information = await coreService.confirmEmailAddressChange(user, confirmationCode);
